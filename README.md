This is a set of Node.js Examples from my SELF 2013 Talk.

The root directory contains a Vagrant file and set of Chef recipes for building a
basic node development environment. If you're not familiar with Vagrant, 
read more about it at http://www.vagrantup.com.
...
Once you have the pre-requisites installed, you should be able to clone this repository 
    ...
    git clone https://github.com/semmypurewal/node-self-examples.git

and change to your new project directory to start your VM:

    cd node-self-examples
    vagrant up
...
You can run the examples by ssh'ing into your VM, installing the dependencies, and then running them.
